					...
					<div class="form-add">
						...
						<div class="card-body">
							<div class="panel-body">
								<form:form modelAttribute="jeans"
									action="/admin/clothes/add-jeans" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="required">Pipe:</label>
										<form:input path="pipe" class="form-control" />
									</div>
									<div class="form-group">
