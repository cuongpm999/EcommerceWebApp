				...
				<div class="col-md-12">
					<div class="form-add">
						<input class="form-control" id="myInput" type="text"
							...
							href="/admin/clothes/add-swimwear" class="btn btn-success"
						...
						<table class="table">
							...
							<tbody id="myTable">
								<c:forEach items="${swimwears }" var="swimwear">
									<tr>
										<td>${swimwear.name }</td>
										<td>${swimwear.style }</td>
										<td>${swimwear.material }</td>
										<td>${swimwear.color }</td>
										<td>${swimwear.bustSize }</td>
										<td>${swimwear.waistSize }</td>
										<td>${swimwear.hipsSize }</td>
										<td><a href="/admin/clothes/edit-swimwear/${swimwear.id }"
											class="btn btn-primary">Edit <i class="fas fa-edit"></i></a>
											<a href="javascript:void(0);"
											onclick="Shop.deleteProduct(${swimwear.id },'/admin/clothes/delete-swimwear/')"
