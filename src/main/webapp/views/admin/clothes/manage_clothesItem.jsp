				...
				<div class="col-md-12">
					<div class="form-add">
						<input class="form-control" id="myInput" type="text"
							placeholder="Search.."> <a href="/admin/add-clothes-item"
							class="btn btn-success" style="margin-top: 10px"><i
							class="fas fa-plus"></i> Add clothes item</a>
						<h1 class="my-3"></h1>
						...
						<table class="table">
							...
							<tbody id="myTable">
								<c:forEach items="${clothesItems }" var="clothesItem">
									<tr>
										<td><img
											src="/files_item/${clothesItem.imgClothesItems.get(0).name }"
											alt="product" style="width: 150px; height: 150px"></td>
										<td>${clothesItem.clothes.name }</td>
										<td><fmt:formatNumber type="number" maxFractionDigits="3"
												value="${clothesItem.price }" /> ₫</td>
										<td>${clothesItem.discount }</td>
										<td><a href="/admin/edit-clothes-item/${clothesItem.barCode }"
											class="btn btn-primary">Edit <i class="fas fa-edit"></i></a>
											<a href="javascript:void(0);"
											onclick="Shop.deleteProduct('${clothesItem.barCode }','/admin/delete-clothes-item/')"
