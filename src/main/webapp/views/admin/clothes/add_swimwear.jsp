						...
						<div class="form-add">
							...
							<div class="card-body">
								<div class="panel-body">
									<form:form modelAttribute="swimwear" action="/admin/clothes/add-swimwear">
										...
										<div class="form-group">
											<label class="required">Bust size:</label>
											<form:input path="bustSize" class="form-control" />
										</div>
										<div class="form-group">
											<label class="required">Waist size:</label>
											<form:input path="waistSize" class="form-control" />
										</div>
										<div class="form-group">
											<label class="required">Hips size:</label>
											<form:input path="hipsSize" class="form-control" />
										</div>
