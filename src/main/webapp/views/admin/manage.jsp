					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="/admin/manage/book">Book</a> 
								<a class="dropdown-item" href="/admin/manage/laptop">Laptop</a> 
								<a class="dropdown-item" href="/admin/manage/mobilephone">Mobile phone</a> 
								<a class="dropdown-item" href="/admin/manage/tivi">Tivi</a>
								<a class="dropdown-item" href="/admin/manage/jeans">Jeans</a>
								<a class="dropdown-item" href="/admin/manage/dresses">Dresses</a>
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="/admin/add-laptop">Laptop</a> 
								<a class="dropdown-item" href="/admin/add-banner">Banner</a>
							</div>
						</li>
