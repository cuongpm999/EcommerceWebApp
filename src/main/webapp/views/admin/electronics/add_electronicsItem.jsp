					...
					<div class="form-add">
						...
						<div class="card-body">
							<div class="panel-body">
								<form:form modelAttribute="electronicsItem"
									action="/admin/add-electronics-item"
									enctype="multipart/form-data">
									<div class="form-group">
										<label class="required" for="txtInput">Electronics:</label>
										<form:select class="form-control" path="electronics.id">
									...
									<div class="form-group">
										<label class="required">Img:&ensp;</label> <input type="file"
											name="electronicsImage" multiple="multiple" />
									</div>
